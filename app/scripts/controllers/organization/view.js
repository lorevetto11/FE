 ...
 */
angular.module('APP')
        .controller('OrderViewCtrl', function ($scope, $state, $stateParams, $translate, $q, $uibModal, currentUser, currentOrganization, ModalService, APIService, ResourceService, StorageService, notify, UtilsService, ENV) {
