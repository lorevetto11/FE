  ...
  grunt.initConfig({
    ...
    ngconstant: {
      options: {
        ...
        wrap: '"use strict";\n\n {%= __ngModule %}',
        name: 'APP.config',
        dest: '<%= yeoman.app %>/config/scripts/config.js'
      },
      development: {
        constants: {
          ENV: {
            name: 'development',
            appName: 'Safeaty Check Management',
            version: '1.0.' + grunt.file.readJSON('package.json').build,
            //hostEndpoint: 'http://ec2-54-93-232-145.eu-central-1.compute.amazonaws.com:8080/SCM/services/',
            hostEndpoint: 'http://localhost:8080/SCM/services/',
            language: 'en-US',
            googleApiKey: 'AIzaSyCceoQcI9-Qi6n9x92sDO8PIxnCV4HCV4U'
          }
        }
      },
      deployment: {
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/assets/{,*/}*.{png,jpg,jpeg,gif,webp,svg,woff,woff2,ttf}',
    ...
    copy: {
      ...
      vendorJS: {
        ...
        src:    ['scripts.js','vendor.js', 'moment.js', 'pdf.js', 'pdf.worker.js'],
      }
    },
